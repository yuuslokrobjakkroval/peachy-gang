...
REM Remove the problematic v4 packages
echo 📦 Removing Tailwind v4 packages...
call npm uninstall @tailwindcss/postcss tailwindcss

REM Install stable Tailwind CSS v3 with required dependencies
echo 📦 Installing stable Tailwind CSS v3...
call npm install -D tailwindcss@^3.4.17 autoprefixer@^10.4.20 postcss@^8.4.49
