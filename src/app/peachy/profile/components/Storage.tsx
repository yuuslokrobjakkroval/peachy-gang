  ...
  return (
    <Card className="w-full h-full p-4">
      ...
      <div className="mb-auto flex flex-col items-center justify-center">
        ...
        <p className="px-5 text-center text-base font-normal text-muted-foreground md:!px-0 xl:!px-8">
      ...
      <div className="flex flex-col">
        <div className="flex justify-between">
          <p className="text-sm font-medium text-muted-foreground">25.6 GB</p>
          <p className="text-sm font-medium text-muted-foreground">50 GB</p>
        </div>
