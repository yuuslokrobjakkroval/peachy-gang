...
export const config: AppConfig = {
  ...
  inviteUrl: `https://discord.com/api/oauth2/authorize?client_id=${FIRST_SUB_BOT_CLIENT_ID}&permissions=8&scope=bot%20applications.commands`,
  guild: {
    filter: (guild) =>
...
export const configPeach: AppConfig = {
  ...
  inviteUrl: `https://discord.com/oauth2/authorize?client_id=${SECOND_SUB_BOT_CLIENT_ID}&permissions=8&scope=bot%20applications.commands`,
  guild: {
    filter: (guild) =>
      (Number(guild.permissions) & PermissionFlags.ADMINISTRATOR) !== 0,
  },
