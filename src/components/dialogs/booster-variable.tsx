...
const guildMessages = [
  ...
  { label: "Server Total Boosts", value: "${guildtotalboosts}" },
  { label: "Server Boost Level", value: "${guildboostlevel}" },
  {
    label: "Boosts Missing for Next Level",
    value: "${guildboostsmissingfornext}",
  },
  { label: "Next Boost Level", value: "${guildboostnextlevel}" },
];

const BoosterVariableDialog = ({
  isOpen,
  onClose,
}: {
  isOpen: boolean;
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px] rounded-2xl">
        <DialogHeader>
          <DialogTitle>Booster Variables</DialogTitle>
          <DialogClose />
        </DialogHeader>
...
export default BoosterVariableDialog;
